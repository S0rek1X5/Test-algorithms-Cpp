...
int main(){
	char letra;
	int cont,i,n,numeros[100],suma=0,multiplicacion,hel;
	...
	switch(letra){
		...
		cout<<"La suma de sus numeros es: "<<suma;break;
		case 'B':
			for(int cont2=0;cont<=n;cont2++){
				multiplicacion=numeros[cont2]*numeros[hel];
				hel=multiplicacion;
			}
		cout<<"La multiplicacion de sus numeros es: "<<multiplicacion;break;
		default:
			cout<<"Usted ha digitado un numero NO REGISTRADO, vuelva a intentarlo";break;
	}
	return 0;
}
